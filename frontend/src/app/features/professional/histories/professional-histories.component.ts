                      ...
                      <div class="foot-item-sm">
                        <svg viewBox="0 0 80 140" width="44" height="77">
                          <g transform="scale(-1,1) translate(-80,0)">
                            <path [class.foot-yes]="h.plantillas" class="foot-path-sm" d="M 40 130 C 56 132 66 123 66 109 C 66 95 64 81 62 69 C 60 59 59 51 57 45 C 53 39 46 37 40 37 C 34 37 27 39 23 45 C 21 51 20 59 18 69 C 16 81 14 95 14 109 C 14 123 24 132 40 130 Z"/>
