                ...
                <div class="edit-field">
                  ...
                  <div class="plantilla-toggle" (click)="editForm.plantillas = !editForm.plantillas">
                    <div class="foot-item-sm">
                      <svg viewBox="0 0 80 140" width="32" height="56"><g transform="scale(-1,1) translate(-80,0)"><path [class.foot-yes]="editForm.plantillas" class="foot-path-sm" d="M 40 130 C 56 132 66 123 66 109 C 66 95 64 81 62 69 C 60 59 59 51 57 45 C 53 39 46 37 40 37 C 34 37 27 39 23 45 C 21 51 20 59 18 69 C 16 81 14 95 14 109 C 14 120 20 125 28 127 C 32 128 34 120 32 110 C 30 95 34 85 40 90 C 48 100 50 115 52 125 C 54 130 48 132 40 130 Z"/><ellipse [class.foot-yes]="editForm.plantillas" class="foot-path-sm" cx="22" cy="22" rx="9" ry="10"/><ellipse [class.foot-yes]="editForm.plantillas" class="foot-path-sm" cx="33" cy="15" rx="7" ry="8"/><ellipse [class.foot-yes]="editForm.plantillas" class="foot-path-sm" cx="43" cy="13" rx="6" ry="7"/><ellipse [class.foot-yes]="editForm.plantillas" class="foot-path-sm" cx="53" cy="15" rx="5" ry="6"/><ellipse [class.foot-yes]="editForm.plantillas" class="foot-path-sm" cx="61" cy="21" rx="4" ry="5"/></g></svg>
                      <span class="foot-lbl">I</span>
                    </div>
                    <div class="foot-item-sm">
                      <svg viewBox="0 0 80 140" width="32" height="56"><path [class.foot-yes]="editForm.plantillas" class="foot-path-sm" d="M 40 130 C 56 132 66 123 66 109 C 66 95 64 81 62 69 C 60 59 59 51 57 45 C 53 39 46 37 40 37 C 34 37 27 39 23 45 C 21 51 20 59 18 69 C 16 81 14 95 14 109 C 14 120 20 125 28 127 C 32 128 34 120 32 110 C 30 95 34 85 40 90 C 48 100 50 115 52 125 C 54 130 48 132 40 130 Z"/><ellipse [class.foot-yes]="editForm.plantillas" class="foot-path-sm" cx="22" cy="22" rx="9" ry="10"/><ellipse [class.foot-yes]="editForm.plantillas" class="foot-path-sm" cx="33" cy="15" rx="7" ry="8"/><ellipse [class.foot-yes]="editForm.plantillas" class="foot-path-sm" cx="43" cy="13" rx="6" ry="7"/><ellipse [class.foot-yes]="editForm.plantillas" class="foot-path-sm" cx="53" cy="15" rx="5" ry="6"/><ellipse [class.foot-yes]="editForm.plantillas" class="foot-path-sm" cx="61" cy="21" rx="4" ry="5"/></svg>
              ...
              <div class="edit-fields">
                ...
                <div class="edit-field">
                  ...
                  <div class="plantilla-toggle" (click)="newHistoryForm.plantillas = !newHistoryForm.plantillas">
                    <div class="foot-item-sm">
                      <svg viewBox="0 0 80 140" width="32" height="56"><g transform="scale(-1,1) translate(-80,0)"><path [class.foot-yes]="newHistoryForm.plantillas" class="foot-path-sm" d="M 40 130 C 56 132 66 123 66 109 C 66 95 64 81 62 69 C 60 59 59 51 57 45 C 53 39 46 37 40 37 C 34 37 27 39 23 45 C 21 51 20 59 18 69 C 16 81 14 95 14 109 C 14 120 20 125 28 127 C 32 128 34 120 32 110 C 30 95 34 85 40 90 C 48 100 50 115 52 125 C 54 130 48 132 40 130 Z"/><ellipse [class.foot-yes]="newHistoryForm.plantillas" class="foot-path-sm" cx="22" cy="22" rx="9" ry="10"/><ellipse [class.foot-yes]="newHistoryForm.plantillas" class="foot-path-sm" cx="33" cy="15" rx="7" ry="8"/><ellipse [class.foot-yes]="newHistoryForm.plantillas" class="foot-path-sm" cx="43" cy="13" rx="6" ry="7"/><ellipse [class.foot-yes]="newHistoryForm.plantillas" class="foot-path-sm" cx="53" cy="15" rx="5" ry="6"/><ellipse [class.foot-yes]="newHistoryForm.plantillas" class="foot-path-sm" cx="61" cy="21" rx="4" ry="5"/></g></svg>
                      <span class="foot-lbl">I</span>
                    </div>
                    <div class="foot-item-sm">
                      <svg viewBox="0 0 80 140" width="32" height="56"><path [class.foot-yes]="newHistoryForm.plantillas" class="foot-path-sm" d="M 40 130 C 56 132 66 123 66 109 C 66 95 64 81 62 69 C 60 59 59 51 57 45 C 53 39 46 37 40 37 C 34 37 27 39 23 45 C 21 51 20 59 18 69 C 16 81 14 95 14 109 C 14 120 20 125 28 127 C 32 128 34 120 32 110 C 30 95 34 85 40 90 C 48 100 50 115 52 125 C 54 130 48 132 40 130 Z"/><ellipse [class.foot-yes]="newHistoryForm.plantillas" class="foot-path-sm" cx="22" cy="22" rx="9" ry="10"/><ellipse [class.foot-yes]="newHistoryForm.plantillas" class="foot-path-sm" cx="33" cy="15" rx="7" ry="8"/><ellipse [class.foot-yes]="newHistoryForm.plantillas" class="foot-path-sm" cx="43" cy="13" rx="6" ry="7"/><ellipse [class.foot-yes]="newHistoryForm.plantillas" class="foot-path-sm" cx="53" cy="15" rx="5" ry="6"/><ellipse [class.foot-yes]="newHistoryForm.plantillas" class="foot-path-sm" cx="61" cy="21" rx="4" ry="5"/></svg>
                      <span class="foot-lbl">D</span>
                    </div>
                    ...
                    <div class="history-detail">
                      ...
                      <div class="detail-section">
                        ...
                        <div class="feet-display">
                          <div class="foot-item-sm">
                            <svg viewBox="0 0 80 140" width="44" height="77"><g transform="scale(-1,1) translate(-80,0)"><path [class.foot-yes]="h.plantillas" class="foot-path-sm" d="M 40 130 C 56 132 66 123 66 109 C 66 95 64 81 62 69 C 60 59 59 51 57 45 C 53 39 46 37 40 37 C 34 37 27 39 23 45 C 21 51 20 59 18 69 C 16 81 14 95 14 109 C 14 120 20 125 28 127 C 32 128 34 120 32 110 C 30 95 34 85 40 90 C 48 100 50 115 52 125 C 54 130 48 132 40 130 Z"/><ellipse [class.foot-yes]="h.plantillas" class="foot-path-sm" cx="22" cy="22" rx="9" ry="10"/><ellipse [class.foot-yes]="h.plantillas" class="foot-path-sm" cx="33" cy="15" rx="7" ry="8"/><ellipse [class.foot-yes]="h.plantillas" class="foot-path-sm" cx="43" cy="13" rx="6" ry="7"/><ellipse [class.foot-yes]="h.plantillas" class="foot-path-sm" cx="53" cy="15" rx="5" ry="6"/><ellipse [class.foot-yes]="h.plantillas" class="foot-path-sm" cx="61" cy="21" rx="4" ry="5"/>@if(h.plantillas){<ellipse cx="40" cy="112" rx="15" ry="9" class="foot-zone-sm"/><ellipse cx="24" cy="57" rx="10" ry="6" class="foot-zone-sm"/><ellipse cx="56" cy="55" rx="9" ry="6" class="foot-zone-sm"/>}</g></svg>
                            <span class="foot-lbl">I</span>
                          </div>
                          <div class="foot-item-sm">
                            <svg viewBox="0 0 80 140" width="44" height="77"><path [class.foot-yes]="h.plantillas" class="foot-path-sm" d="M 40 130 C 56 132 66 123 66 109 C 66 95 64 81 62 69 C 60 59 59 51 57 45 C 53 39 46 37 40 37 C 34 37 27 39 23 45 C 21 51 20 59 18 69 C 16 81 14 95 14 109 C 14 120 20 125 28 127 C 32 128 34 120 32 110 C 30 95 34 85 40 90 C 48 100 50 115 52 125 C 54 130 48 132 40 130 Z"/><ellipse [class.foot-yes]="h.plantillas" class="foot-path-sm" cx="22" cy="22" rx="9" ry="10"/><ellipse [class.foot-yes]="h.plantillas" class="foot-path-sm" cx="33" cy="15" rx="7" ry="8"/><ellipse [class.foot-yes]="h.plantillas" class="foot-path-sm" cx="43" cy="13" rx="6" ry="7"/><ellipse [class.foot-yes]="h.plantillas" class="foot-path-sm" cx="53" cy="15" rx="5" ry="6"/><ellipse [class.foot-yes]="h.plantillas" class="foot-path-sm" cx="61" cy="21" rx="4" ry="5"/>@if(h.plantillas){<ellipse cx="40" cy="112" rx="15" ry="9" class="foot-zone-sm"/><ellipse cx="24" cy="57" rx="10" ry="6" class="foot-zone-sm"/><ellipse cx="56" cy="55" rx="9" ry="6" class="foot-zone-sm"/>}</svg>
                            <span class="foot-lbl">D</span>
                          </div>
